class FlightIndicators {
  ...
  updateHeading(heading) {
    let meter = this.placeholder.querySelector(
      "div.instrument.heading div.heading"
    );
  ...
  updateCoordinator(turn) {
    let meter = this.placeholder.querySelector(
      "div.instrument.turn-coordinator div.turn"
    );
  ...
  updateVerticalSpeed(vSpeed) {
    ...
    let meter = this.placeholder.querySelector(
      "div.instrument.vertical-speed div.vertical-speed"
    );
  ...
  updateAirSpeed(speed) {
    ...
    let meter = this.placeholder.querySelector(
      "div.instrument.airspeed div.speed"
    );
  ...
  updateAltitude(altitude) {
    ...
    let smallMeter = this.placeholder.querySelector(
      "div.instrument.altimeter div.small-needle"
    );
  ...
  showBox() {
    // let box = this.placeholder.querySelector('img.box.background')
    let box = this.placeholder.querySelector(
      "div.instrument img.box.background"
    );
    ...
    for (const prop in object) {
      if (object.hasOwnProperty(prop)) {
        ...
        if (deep && isObject(object[prop])) {
          extended[prop] = this.mergeOptions(
            true,
            extended[prop],
            object[prop]
          );
  ...
  createHeadingIndicator(imgDirectory) {
    ...
    const heading = this.createDivBox(
      "heading",
      imgDirectory,
      "heading_yaw.svg"
    );
  ...
  createAltimeterIndicator(imgDirectory) {
    ...
    const pressure = this.createDivBox(
      "pressure",
      imgDirectory,
    ...
    const smallNeedle = this.createDivBox(
      "small-needle",
      imgDirectory,
      "fi_needle_small.svg"
    );
  ...
  createAirspeedIndicator(imgDirectory) {
    ...
    const speedMechanics = this.createImgBox(
      imgDirectory,
      "speed_mechanics.svg"
    );
